 ...
 * is at least double the amount of the other one, the party is great (2). However, in all cases, if either tea or candy
...
public class teaParty {
    ...
    public int teaPartyOldSolution(int tea, int candy) {
